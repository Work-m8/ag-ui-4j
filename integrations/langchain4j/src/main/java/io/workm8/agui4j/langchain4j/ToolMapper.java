...
public class ToolMapper {
    ...
    /**
     * Converts an agui4j Tool to a LangChain4j ToolSpecification.
     * <p>
     ...
     *
     * @param tool the agui4j Tool to convert
    ...
    public ToolSpecification toLangchainTool(final Tool tool) {
        return ToolSpecification.builder()
                ...
                .parameters(
                        this.toJsonObjectSchema(tool.parameters())
                ).build();
    }

    /**
     * Converts agui4j ToolParameters to a LangChain4j JsonObjectSchema.
     * <p>
     * This protected method handles the conversion of tool parameter definitions
     * from agui4j's format to LangChain4j's JSON Object Schema format. The schema
     ...
     * </ul>
     *
     * @param params the agui4j ToolParameters containing parameter definitions
    ...
    protected JsonObjectSchema toJsonObjectSchema(Tool.ToolParameters params) {
        ...
        params.properties().forEach((key, value) -> {
            switch (value.type()) {
                case "string" -> builder.addStringProperty(key, value.description());
